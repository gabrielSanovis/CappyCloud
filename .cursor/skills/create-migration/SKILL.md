...
description: >-
  Cria e gerencia migrations de banco de dados com Alembic no CappyCloud.
  Use quando o usuário pedir para criar uma migration, alterar schema, adicionar tabela,
  adicionar coluna, renomear campo, ou qualquer mudança no banco de dados.
  NUNCA crie arquivos de migration manualmente — sempre use o comando Alembic.
---
